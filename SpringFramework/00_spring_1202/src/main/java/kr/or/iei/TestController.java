...
public class TestController {
	...
	public TestController() {
		System.out.println("TestController가 생성되었습니다.");
	}
	...
	@PostMapping("/springParamTest.kh")
	...
	public String springResponseTest1(Model model) {	//Model : 데이터만을 등록하고 응답할 때 사용되는 클래스
		model.addAttribute("resTest1", "spring responseData 1");
		model.addAttribute("resTest2", "spring responseData 2");
		/*
			servlet-context.xml 파일 내부 일부 코드
			
			prefix : /WEB-INF/views
			suffix : .jsp
			
				prefix 			+ 	return 값				+ 	suffix
			/WEB-INF/views/		+ 	resTest/springResponse 	+	.jps
		*/
